      ...
      <div class="container ">
        <div class="row-login row justify-content-center align-items-center">
          <div class="col-auto border border-dark col-md-5 p-4 bg-light opacity-75 rounded-4">
            ...
            <div class="text-center opacity-75 rounded-5">
                @if(session('msg'))
            ...
            <form class="form-horizontal" method="post"  action="{{route('user.store')}}">
              ...
              <div class="form-group">
                <div class="col-md-8 offset-md-2 py-2">
                    ...
                    <input class="form-control col-md-8 border border-dark" type="text"  name="user_nome"  placeholder="Nome Completo">
                </div>
                <div class="text-center text-danger">
                    {{ $errors ->first('user_nome')}}
                </div>               
              </div>  
              ...
              <div class="form-group">
                <div class="col-md-8 offset-md-2 py-2">
                    <label>EMAIL:</label>
                    <input class="form-control col-md-8 border border-dark" type="email" name="user_email"  placeholder="exemplo@hotmail.com">
                </div>
                <div class="text-center text-danger">
              ...
              <div class="form-group">
                <div class="col-md-8 offset-md-2 py-2">
                    <label>SENHA:</label>
                    <input class="form-control col-md-8 border border-dark" type="password" Minlength="8" name="user_senha"  placeholder="Sua Senha">
                </div>
                <div class="text-center text-danger">
                    {{ $errors ->first('user_senha')}}
                </div> 
              </div>                       
              ...
              <div class="form-group">
                <div class="text-center py-3">
                    ...
                    <a class="btn btn-outline-dark col-md-3 rounded" href="/" >Login</a> 
                </div>
              </div>  
